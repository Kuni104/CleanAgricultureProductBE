...
namespace CleanAgricultureProductBE.Repositories.Order
{
    public interface IOrderRepository
    {
        ...
        public Task<List<Models.Order>> GetAllOrdersInScheduleWithPagination(Guid scheduleId, int offset, int pageSize, string keyword);
        public Task<List<Models.Order>> GetAllOrdersWithPagination(int offset, int pageSize, string keyword);
        ...
        public Task<List<Models.Order>> GetOrdersByCustomerIdWithPagination(Guid customerId, int offset, int pageSize, string keyword);
